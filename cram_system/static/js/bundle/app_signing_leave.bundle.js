...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SigningLeave = __webpack_require__(179);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SigningLeaveMain = __webpack_require__(180);

	var SigningLeave = function (_React$Component) {
	  _inherits(SigningLeave, _React$Component);

	  function SigningLeave() {
	    _classCallCheck(this, SigningLeave);

	    return _possibleConstructorReturn(this, (SigningLeave.__proto__ || Object.getPrototypeOf(SigningLeave)).apply(this, arguments));
	  }

	  _createClass(SigningLeave, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	        ...
	        React.createElement(SigningLeaveMain, null),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SigningActualMain = function (_React$Component) {
	  ...
	  function SigningActualMain() {
	    _classCallCheck(this, SigningActualMain);

	    var _this = _possibleConstructorReturn(this, (SigningActualMain.__proto__ || Object.getPrototypeOf(SigningActualMain)).call(this));
	  ...
	  _createClass(SigningActualMain, [{
	    key: 'getSigningExpect',
	    value: function getSigningExpect(specific_date) {
	      return fetch('http://localhost:8000/api/v1.0/study_manage/signing/leave/' + specific_date + '/', {
	        accept: 'application/json',
	        method: 'get'
