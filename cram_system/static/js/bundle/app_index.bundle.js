	...
	var IndexMain = function (_React$Component) {
	  ...
	  _createClass(IndexMain, [{
	    ...
	    value: function render() {
	      ...
	      var signingListGroups = React.createElement(SigningListGroups, { expected: 40, actual: 25, absent: 10, leave: 5 });
	      var quizCreateListGroups = React.createElement(QuizCreateListGroups, { expected: 25, done: 20, not_done: 5 });
	      var homeworkListGroups = React.createElement(HomeworkListGroups, { expected: 25, done: 23, not_done: 2 });
	      var quizListGroups = React.createElement(QuizListGroups, { expected: 20, done: 17, not_done: 3 });
	      var planListGroups = React.createElement(PlanListGroups, { expected: 25, done: 23, not_done: 2 });
	      var leftListGroups = React.createElement(LeftListGroups, { total: 25, can_left: 5, left: 3, not_left: 22 });
