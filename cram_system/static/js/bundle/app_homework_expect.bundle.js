...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HomeworkExpect = __webpack_require__(166);

	ReactDOM.render(React.createElement(HomeworkExpect, null), document.getElementById('app'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HomeworkExpectMain = __webpack_require__(167);

	var HomeworkExpect = function (_React$Component) {
	  _inherits(HomeworkExpect, _React$Component);

	  function HomeworkExpect() {
	    _classCallCheck(this, HomeworkExpect);

	    return _possibleConstructorReturn(this, (HomeworkExpect.__proto__ || Object.getPrototypeOf(HomeworkExpect)).apply(this, arguments));
	  }

	  _createClass(HomeworkExpect, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	        ...
	        React.createElement(HomeworkExpectMain, null),
	        React.createElement(CramFooter, null)
	      );
	    }
	  }]);

	  return HomeworkExpect;
	}(React.Component);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HomeworkExpectMain = function (_React$Component) {
	  _inherits(HomeworkExpectMain, _React$Component);

	  function HomeworkExpectMain() {
	    _classCallCheck(this, HomeworkExpectMain);

	    var _this = _possibleConstructorReturn(this, (HomeworkExpectMain.__proto__ || Object.getPrototypeOf(HomeworkExpectMain)).call(this));
	    ...
	    _this.getHomeworkExpect = _this.getHomeworkExpect.bind(_this);
	    _this.checkStatus = _this.checkStatus.bind(_this);
	    _this.parseJSON = _this.parseJSON.bind(_this);
	    ...
	    _this.getHomeworkExpect(date);
	    return _this;
	  }

	  _createClass(HomeworkExpectMain, [{
	    key: 'getHomeworkExpect',
	    value: function getHomeworkExpect(specific_date) {
	  ...
	  return HomeworkExpectMain;
	}(React.Component);

	module.exports = HomeworkExpectMain;
