...
/***/ (function(module, exports, __webpack_require__) {
	...
	var QuizCreateDone = function (_React$Component) {
	  ...
	  function QuizCreateDone() {
	    _classCallCheck(this, QuizCreateDone);

	    return _possibleConstructorReturn(this, (QuizCreateDone.__proto__ || Object.getPrototypeOf(QuizCreateDone)).apply(this, arguments));
	  }

	  _createClass(QuizCreateDone, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	        ...
	        React.createElement(QuizCreateDoneMain, null),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var QuizCreateDoneMain = function (_React$Component) {
	  ...
	  function QuizCreateDoneMain() {
	    _classCallCheck(this, QuizCreateDoneMain);

	    var _this = _possibleConstructorReturn(this, (QuizCreateDoneMain.__proto__ || Object.getPrototypeOf(QuizCreateDoneMain)).call(this));
	    ...
	    _this.getQuizCreateDone = _this.getQuizCreateDone.bind(_this);
	    ...
	    _this.getQuizCreateDone(date);
	    return _this;
	  }

	  _createClass(QuizCreateDoneMain, [{
	    key: 'getQuizCreateDone',
	    value: function getQuizCreateDone(specific_date) {
	      return fetch('http://localhost:8000/api/v1.0/study_manage/quiz_create/done/' + specific_date + '/', {
