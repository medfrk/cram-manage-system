...
class HomeworkExpectMain extends React.Component {
  constructor() {
    super();
    this.state = {
      students: [],
    ...
    this.getHomeworkExpect = this.getHomeworkExpect.bind(this);
  ...
  getHomeworkExpect(specific_date) {
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <div className="row"> <h3 style={hStyle}>作業登記名單</h3></div>
        <div className="row">
