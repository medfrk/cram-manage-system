...
class PlanNotDoneMain extends React.Component {
  constructor() {
    super();
    this.state = {
      students: [],
    ...
    this.getPlanNotDone = this.getPlanNotDone.bind(this);
    ...
    this.getPlanNotDone(date)
  }

  getPlanNotDone(specific_date) {
    return fetch('http://localhost:8000/api/v1.0/study_manage/plan/not_done/' + specific_date + '/', {
    ...
    var studentPlanTableRowList = this.state.students['signing_list'].map((student, index) => {
      return (
        <PlanTableRowForToday
          ...
          back_url='http://localhost:8000/plan_not_done/'
        />
      )
    });
    this.setState({
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <div className="row"> <h3 style={hStyle}>尚未讀計名單</h3></div>
        <div className="row">
...
module.exports = PlanNotDoneMain;
