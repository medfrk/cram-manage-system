...
class PlanToPrintRow extends React.Component {
  constructor(){
    super();
    ...
    fetch('/api/v1.0/basic/student/plan/' + this.props.plan_id + '/', {
      method: 'PATCH',
      headers: {
  ...
  render() {
    ...
    return(
      <tr>
        ...
        <td>{this.props.plan_range}</td>
        <td>{this.props.plan_note}</td>
