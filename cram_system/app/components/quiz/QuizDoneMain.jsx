...
class QuizDoneMain extends React.Component {
  constructor() {
    super();
    this.state = {
      students: [],
    ...
    this.getQuizDone = this.getQuizDone.bind(this);
    ...
    this.getQuizDone(date)
  }

  getQuizDone(specific_date) {
    return fetch('http://localhost:8000/api/v1.0/study_manage/quiz/done/' + specific_date + '/', {
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <div className="row"> <h3 style={hStyle}>考試已完成名單</h3></div>
        <div className="row">
