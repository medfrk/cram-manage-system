...
class QuizCreateDoneMain extends React.Component {
  constructor() {
    super();
    this.state = {
      students: [],
    ...
    this.getQuizCreateDone = this.getQuizCreateDone.bind(this);
  ...
  getQuizCreateDone(specific_date) {
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <div className="row"> <h3 style={hStyle}>小考登記已完成名單</h3></div>
        <div className="row">
