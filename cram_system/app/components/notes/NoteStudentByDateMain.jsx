...
var NoteStudentByDateRow = require('NoteStudentByDateRow');

class NoteStudentByDateMain extends React.Component {
  constructor() {
    super();
  ...
  getNotes() {
    return fetch('/api/v1.0/note/get_by_date/student/' + this.state.date + '/', {
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <div>
          <div className="row"><h3 style={hStyle}>自習回報</h3></div>
        </div>
...
module.exports = NoteStudentByDateMain;
